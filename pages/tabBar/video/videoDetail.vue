<template>
	...
	<scroll-view class="video-detail" scroll-y="true" >
		...
		<view class="video-wrapper">
			<video :src="detailInfo.video_play_url" class="video" :poster="detailInfo.poster_url" controls objectFit="fill" :autoplay="false"></video>
		</view>
		<!-- 相关推荐 -->
		<view class="content">
			<!-- 推荐 -->
			<view class="s-header">
				...
				<view class="rec-section" v-for="item in detailInfo.newsList" :key="item.id">
					<view class="rec-item">
						...
						<view class="right">
							<image :src="item.images[0]" mode="aspectFill" class="img"></image>
							<view class="video-tip">
								<uni-icons type="videocam" size="50" class="icon" color="#fff"></uni-icons>
							</view>
						</view>
					</view>
				</view>
